...
ESPECIALISTAS_NATIVOS = {
    "especialista_saudacao": {
        ...
        "prompt_sistema": (
            ...
            "     Cumprimente pelo primeiro nome e faça uma pergunta curta de roteamento\n"
            "     (ex.: \"Como posso ajudar você hoje?\"). Se a empresa tiver alguma tag de triagem cadastrada\n"
            "     (consulte com `tool_consultar_tags_empresa`) cuja `instrucao_ia` indique uso ao final desta\n"
            "     etapa, você pode aplicá-la via `tool_aplicar_tag_dinamica` usando o tag_id real.\n"
