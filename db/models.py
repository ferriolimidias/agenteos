...
class Empresa(Base):
    ...
    limite_certeza = Column(Float, nullable=False, default=0.65)
    limite_duvida = Column(Float, nullable=False, default=0.45)
    max_agentes_desempate = Column(Integer, nullable=False, default=3)
