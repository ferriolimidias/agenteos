...
MIGRATIONS = [
    ...
    "ALTER TABLE vetores_conhecimento ADD COLUMN IF NOT EXISTS source_name VARCHAR NULL;",
    "ALTER TABLE vetores_conhecimento ADD COLUMN IF NOT EXISTS source_type VARCHAR NULL;",
