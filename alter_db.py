...
MIGRATIONS = [
    ...
    "ALTER TABLE empresas ADD COLUMN IF NOT EXISTS openai_api_key VARCHAR NULL;",
    "ALTER TABLE empresas ADD COLUMN IF NOT EXISTS telefone_notificacao VARCHAR NULL;",
    "ALTER TABLE empresas ADD COLUMN IF NOT EXISTS status_openai VARCHAR NOT NULL DEFAULT 'ok';",
    "ALTER TABLE especialistas ADD COLUMN IF NOT EXISTS modelo_llm VARCHAR NOT NULL DEFAULT 'gpt-4o-mini';",
